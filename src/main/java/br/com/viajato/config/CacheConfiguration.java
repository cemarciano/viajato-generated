...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(br.com.viajato.domain.Aeroporto.class.getName() + ".origems", jcacheConfiguration);
            cm.createCache(br.com.viajato.domain.Aeroporto.class.getName() + ".destinos", jcacheConfiguration);
