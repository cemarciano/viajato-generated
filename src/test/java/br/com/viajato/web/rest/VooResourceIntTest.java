...
public class VooResourceIntTest {
    ...
    private static final Aeroporto DEFAULT_ORIGEM = Aeroporto.SDU;
    private static final Aeroporto UPDATED_ORIGEM = Aeroporto.GIG;

    private static final Aeroporto DEFAULT_DESTINO = Aeroporto.SDU;
    private static final Aeroporto UPDATED_DESTINO = Aeroporto.GIG;

    private static final Instant DEFAULT_PARTIDA = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_PARTIDA = Instant.now().truncatedTo(ChronoUnit.MILLIS);

    private static final Instant DEFAULT_CHEGADA = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_CHEGADA = Instant.now().truncatedTo(ChronoUnit.MILLIS);
