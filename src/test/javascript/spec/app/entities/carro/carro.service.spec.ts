    ...
    describe('Carro Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/carros';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Carro', () => {
                service.create(new Carro(null)).subscribe(received => {
            ...
            it('should update a Carro', () => {
                service.update(new Carro(123)).subscribe(received => {
