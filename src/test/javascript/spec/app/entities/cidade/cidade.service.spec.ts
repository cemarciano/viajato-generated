    ...
    describe('Cidade Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/cidades';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Cidade', () => {
                service.create(new Cidade(null)).subscribe(received => {
            ...
            it('should update a Cidade', () => {
                service.update(new Cidade(123)).subscribe(received => {
