    ...
    describe('Telefone Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/telefones';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Telefone', () => {
                service.create(new Telefone(null)).subscribe(received => {
            ...
            it('should update a Telefone', () => {
                service.update(new Telefone(123)).subscribe(received => {
