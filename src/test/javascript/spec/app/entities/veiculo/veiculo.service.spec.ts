    ...
    describe('Veiculo Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/veiculos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Veiculo', () => {
                service.create(new Veiculo(null)).subscribe(received => {
            ...
            it('should update a Veiculo', () => {
                service.update(new Veiculo(123)).subscribe(received => {
